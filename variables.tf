variable "region" {
  description = "Region name where instance will be created in"
  type        = string
}
...
variable "common_tags" {
  description = "A mapping of common tags to assign to the resource"
  type        = map(string)
  default     = {}
}

variable "s3_tags" {
  description = "A mapping of s3 specific tags to assign to the resource"
  type        = map(string)
  default     = {}
}
...
variable "create_bucket_acl" {
  description = "Create s3 bucket ACL or not"
  type        = bool
  default     = false
}
